...
var __gwtModuleFunction = $wnd.gwtexternaldicom;
var $sendStats = __gwtModuleFunction.__sendStats;
$sendStats('moduleStartup', 'moduleEvalStart');
var $gwt_version = "2.7.0";
var $strongName = 'C7FE463A4F6A4738F3510CC69A971D81';
var $gwt = {};
...
function $format(this$static, event_0){
  ...
  $append_0(message, (date = new Date_0(event_0.millis) , s = new StringBuilder , $append_0(s, $toString_5(date)) , s.string += ' ' , $append_0(s, event_0.loggerName) , s.string += '\n' , s.string += 'SEVERE' , s.string += ': ' , s.string));
...
_.toString$ = function toString_21(){
  ...
  for (entry$iterator = new AbstractHashMap$EntrySetIterator((new AbstractHashMap$EntrySet(this)).this$01); $hasNext(entry$iterator);) {
    ...
    sb.string += '=';
    $append_0(sb, $toString_4(this, entry.getValue()));
  }
  sb.string += '}';
  return sb.string;
}
...
function $setVariableBase2(documento2, randomIdVars2){
  ...
  setVariableBase3($toString_2(DocumentoJ), randomIdVars2);
  return DocumentoJ;
}
...
function CompositeDocumentEditionDummy(randomIdVars){
  ...
  Mostar3 = $toString_2(create_2(this.Documento));
  T2 = new Label;
...
function $clinit_GWTExternalDummy(){
  ...
  $wnd.DICOMSetContext = setContext;
  $wnd.DICOMGetIcon = getIcon;
  $wnd.DICOMPersist = getPersist;
  $wnd.DICOMisWaitingUpdate = isWaitingUpdate;
  $wnd.DICOMupdateContext = updateContext;
  $wnd.DICOMsetWaitingUpdate = setWaitingUpdate;
}
...
//# sourceURL=gwtexternaldicom-0.js
